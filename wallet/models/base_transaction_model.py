...
class BaseTransaction(Model):
    ...
    transaction_amount = fields.DecimalField(max_digits=39, decimal_places=9, null=True, default=None)
    transaction_fee = fields.DecimalField(max_digits=39, decimal_places=9, null=True, default=None)
